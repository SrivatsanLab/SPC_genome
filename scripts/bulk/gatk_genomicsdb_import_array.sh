...
##########################################################################################################################
# Per-chromosome GenomicsDB import (SLURM array job)
...
# Arguments
GVCF_DIR="$1"           # Directory containing GVCFs
GENOMICSDB_DIR="$2"     # Base directory for GenomicsDB workspaces (e.g., data/sample/vcfs/genomicsdb)
...
echo "============================================"
echo "GenomicsDB Import for chromosome: ${CHROMOSOME}"
